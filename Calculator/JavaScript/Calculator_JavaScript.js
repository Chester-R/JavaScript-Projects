...
const Calculator = {
    //this is displays 0 the screen
    Display_Value: '0',
    //this will hold the first operand for any experessions, we set it to null for now
    First_Operand: null,
...
function Input_Digit(digit) {
    ...
    if (Wait_Second_Operand === true) {
        ...
        // this overwirtes Display_Value if the current value is 0
...
function Handle_Operator(Next_Operator) {
    ...
    //when an oeprator key is pressed, we convert the current number
