...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        //This variable retrievs the html element id that was clicked.
        ...
        //This condition checks to see of it is computers turn.
        if (activePlayer === 'O') {
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    function animateLineDrawing() {
        //This variable creates the loop for whern the game ends it restarts.
...
function resetGame() {
    ...
    //this retes our array so it is empty and we can start over.
    selectedSquares = [];
}
